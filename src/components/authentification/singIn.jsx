        ...
        <div className="flex  w-full items-center justify-center">
            <form className="flex items-center lg:items-stretch flex-col">
                <div className="mt-16 text-center  md:text-left lg:text-left my-[6%]">
                    <h1 className="mb-10 text-4xl  lg:mb-3">
                        Sign In Page
                    </h1>
                </div>
                ...
                <div>
                    ...
                    <Link className="my-5 lg:my-0 text-end text-[#8A33FD]" to={'https://support.google.com/accounts/answer/41078?hl=en&co=GENIE.Platform%3DDesktop'}>Forget your password?</Link>
                    <button className="w-80 lg:w-40 rounded-md border-[1px] border-black p-4 bg-[#8A33FD] text-white"> Sing in</button>
