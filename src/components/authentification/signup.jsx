    ...
    return(
        <div className="flex  w-full items-center justify-center">
            <form className="flex items-center lg:items-stretch flex-col">
                ...
                <h2 className=" pt-5 lg:pt-0 text-xl md:text-center lg:text-left text-gray-500">Sign up for free to access to in any of our products </h2>
                </div>
            ...
            <div className="w-full text-left lg:mt-10">
                ...
                <select className="p-2 md:w-full w-80 lg:w-[100%] border-[1px] rounded-md lg:p-3 border-[#3C4242]">
                ...
                <div>
                    ...
                    <input  required  type="email" className="p-2 w-80 md:w-full  lg:w-[100%] border-[1px] rounded-md lg:p-3 border-[#3C4242]"/>

                <div className="my-[2%] mt-[5%]">
                    <h2 className="text-2xl lg:text-xl">Password</h2>
                </div>
            </div>
                    <input  required  type="password" className="p-2 w-80 md:w-full lg:w-[100%] border-[1px] rounded-md lg;p-3 border-[#3C4242]" />
                <div className="flex w-80 md:w-96 lg:w-full"> 
                    <h2 className="lg:text-base md:text-xl" >Use 8 or more characters with a mix of letters, numbers & symbols</h2>
                </div>
                    <div className="my-6 w-80 lg:text-base md:text-xl md:w-96 lg:w-full">
                        <div className="flex gap-x-2">
                            <input className="mb-5 lg:mb-0 md:mt-0 lg:mt-1" required type="checkbox"/> <p className=" md:pb-2.5 lg:pb-0"> Agree to our Terms of use and Privacy Policy</p>  
                        </div>
                        <div className="flex gap-x-2">
                            <input type="checkbox" /> <p>Subscribe to our monthly newsletter</p>
                        </div>
                    </div>
                    <button className="w-80 text-xl mt-3 md:w-full lg:mt-0 lg:w-40 rounded-md border-[1px] border-black p-4 bg-[#8A33FD] text-white"> Sign up</button>
