...
function SignUp() {
    ...
    return (
        <div className="flex  w-full items-center justify-center">
            <div className="flex items-center lg:items-stretch flex-col">
                ...
                <form onSubmit={postUser}>
                    ...
                    <button disabled={password.length < 8} className="w-80 md:w-96 lg:w-40 rounded-md border-[1px] border-black p-4 bg-[#8A33FD] text-white cursor-pointer">Sign up</button>
